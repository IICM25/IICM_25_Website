...
function AboutIITK() {
  ...
  return (
    <div className="min-h-screen font-serif text-[#fefae0] overflow-x-hidden">
      ...
      {/* 2. MAIN CONTENT */}
      <div className="relative w-full pt-20" style={{ backgroundColor: theme.bg }}>
        <div
        ...
        <div className="relative z-10">
          ...
          <div
            className="w-full border-y border-[#fefae0]/30 bg-[#000000]/20 backdrop-blur-sm py-12 mb-24 relative group"
            role="region"
            aria-label="IITK highlights carousel"
          >
