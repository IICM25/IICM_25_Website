...
const EventsHubPage = () => {
  return (
    <section
      ...
      style={{ backgroundImage: "url('/images/mid.png')" }} // 🔹 change this path to your actual image
    >
      ...
      <div className="relative container mx-auto px-6 text-center text-white">
        <h1 className="font-title text-5xl md:!text-7xl text-primary drop-shadow-lg">
          Events & Competitions
        </h1>

        <p className="text-lg text-secondary mt-2 max-w-2xl mx-auto drop-shadow-md">
