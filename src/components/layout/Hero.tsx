  ...
  return (
    <main className="min-h-screen 2xl:w-[99.2vw] w-screen overflow-x-hidden">
      ...
      <section className="relative min-h-[230vh] w-full overflow-hidden">
        ...
        {/* {!bgLoaded && ( */}
        <div className="absolute left-0 right-0 z-50 pointer-events-none" style={{ top: '10vh' }}>
                ...
                <div className="relative w-full flex items-center justify-center py-3 ">
                  ...
                  <div className="relative text-center">
                    ...
                    >
                      ...
                      <br/>
                      <span className="text-[1.2rem] md:text-[2rem] lg:text-[2.6rem]">8.0</span>
                    </h1>
      ...
      <section className="relative w-full bg-[#e88f33] speckle">
        {/* top stripe */}
        <div className="absolute xl:left-0 2xl:left-[-5px] right-0 top-[-65px] pointer-events-none z-[40]">
      ...
      <section className="relative w-full min-h-[110vh] h-fit overflow-visible">
        ...
        <div className="absolute left-[0] md:left-[-3] lg:top-[-80px] top-[-40px] pointer-events-none z-[40]">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 lg:px-20 pb-10 pt-24 md:pt-22 lg:pt-30">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-9">
              ...
              <div className="vintage-body text-lg md:text-base lg:text-xl leading-relaxed space-y-6 max-w-3xl">
                <p>
                  The Inter IIT Cultural Meet is an annual celebration of creativity and artistic brilliance across all IITs. It brings together talented students from across the country, offering a vibrant platform for dance, music, drama, literature, art, design, and more. What began as a small initiative for cultural exchange has grown into one of India’s most anticipated intercollegiate events. Each year, a host IIT transforms its campus into a melting pot of ideas and imagination, where participants showcase months of preparation and creative finesse.
                </p>
                ...
                <p>
                  More than a competition, the Meet is a shared journey of learning and expression. From soulful music and powerful theatre to classical performances and dynamic street art every act tells a story and adds a new shade to this cultural canvas. It is a true celebration of diversity, unity, and the creative spirit that defines every IIT.
                </p>


                <p className="font-semibold">
                  Join us as we celebrate expression, imagination, and the timeless energy of the Inter IIT Cultural Meet!
                </p>
              </div>
            </div>
      ...
      <section className="relative w-full overflow-visible bg-[#F3E1A0]">
        ...
        <div className="absolute md:left-[-3] left-0 right-0 md:top-[-74px] top-[-40px]  pointer-events-none z-40">
        ...
        <div className="absolute left-[-1] top-28 md:left-[-2] md:top-42 z-30 pointer-events-none" style={{ width: 120, maxWidth: "18%" }}>
          <div className="relative w-full aspect-[1/1]">
        ...
        <div className="absolute right-0 bottom-[-15] md:bottom-[-55px] lg:bottom-[-90px] z-0 pointer-events-none" style={{ width: "36%", maxWidth: 420 }}>
          <div className="relative w-full aspect-[4/3]">
            <Image src="/Elements/keyboard.png" alt="keyboard" fill style={{ objectFit: "contain" }} priority />
          </div>
        </div>
        {/* spacing for next section */}
        <div className="absolute left-[0] right-0 bottom-[-30] md:bottom-[-50px] lg:bottom-[-120px] md:left-[-1] pointer-events-none z-0">
